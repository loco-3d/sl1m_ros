...
class Sl1mNode:
    ...
    def current_contact_callback(self, msg):
        # rospy.loginfo(
        #     "current_contact_callback(): New contact list. Number of contact : {}".format(
        #         len(msg.transforms)
        #     )
        # )
        ...
        # rospy.loginfo(
        #     "current_contact_callback(): {}".format(self.initial_contacts)
        # )
    ...
    def polygon_callback(self, msg):
        # rospy.loginfo(
        #     "polygon_callback(): New polygon list. Number of surfaces : {}".format(
        #         len(msg.markers)
        #     )
        # )
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.add_start_polygon(all_polygons, initial_contacts)
    ...
    def result_to_ros_msg(self, result, polygons):
        ...
        for i, (limb, end_eff_pose) in enumerate(zip(self.params.limbs, result.all_feet_pos)):
            marker = Marker()
        ...
        for i, polygon in enumerate(polygons):
            ...
            marker.header.frame_id = "memmo_staircase"
